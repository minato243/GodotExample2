...
namespace TerrainEditor.Utils.Editor.Sculpt
{
	public class TerrainSmoothSculpt : TerrainBaseSculpt
	{
		...
		public override void Apply( TerrainPatch patch, Vector3 pos, Vector3 patchPositionLocal, float editorStrength, Vector2 modifiedSize, Vector2i modifiedOffset)
		{
